# 1 "D:/PROJECTS/smart street/smart street.X/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "D:/PROJECTS/smart street/smart street.X/main.c" 2
...
# 8 "D:/PROJECTS/smart street/smart street.X/main.c" 2




# 1 "D:/PROJECTS/smart street/smart street.X/config.h" 1
# 17 "D:/PROJECTS/smart street/smart street.X/config.h"
...
# 12 "D:/PROJECTS/smart street/smart street.X/main.c" 2
# 23 "D:/PROJECTS/smart street/smart street.X/main.c"
unsigned char s_right_1_f = 0;

unsigned char s_right_2_f = 0;

unsigned char s_left_1_f = 0;

unsigned char s_left_2_f = 0;

unsigned char s_top_1_f = 0;

unsigned char s_top_2_f = 0;

unsigned char s_bottom_1_f = 0;

unsigned char s_bottom_2_f = 0;

unsigned char s_square_1_f = 0;
unsigned char s_square_2_f = 0;
# 53 "D:/PROJECTS/smart street/smart street.X/main.c"
void main(void) {
    ADCON1=0x07;
    TRISA = 0x00;
    TRISB = 0xff;
